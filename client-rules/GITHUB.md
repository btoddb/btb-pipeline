...
- **constraint** For GitHub write actions in this repository, prefer the local
  `gh` CLI over a GitHub connector or skill, because `gh` cli has been authenticated with needed permissions.
- **constraint** If you use a github connector or skill and it returns a permission error on a
